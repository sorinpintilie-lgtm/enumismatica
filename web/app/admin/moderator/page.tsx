      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-300 max-w-2xl">
            Acesta este panoul pentru administratorii obișnuiți. Poți aproba și gestiona produse și
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          >
            <h2 className="text-2xl font-semibold text-white mb-2">Produse</h2>
            <p className="text-slate-300 mb-3">
              Vezi și aprobă produsele trimise de utilizatori pentru vânzare directă.
            </p>
            <span className="inline-flex items-center text-gold-400 font-semibold text-sm">
              Mergi la gestionare produse
        ...
        <div className="bg-navy-800/50 border border-blue-500/40 rounded-2xl p-6">
          ...
          <ul className="list-disc list-inside text-slate-300 text-sm space-y-1 mb-4">
            <li>Aproba / respinge produse trimise de utilizatori.</li>
            <li>Aproba / respinge licitații și încheia licitații dacă este necesar.</li>
            <li>Modifica detalii pentru produse și licitații existente.</li>
          </ul>
