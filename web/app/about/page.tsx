...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="bg-gradient-to-br from-amber-600 to-amber-800 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold mb-4">Despre E-numismatica</h1>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-md p-8 text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Autenticitate</h3>
            ...
            <div className="bg-white rounded-lg shadow-md p-8 text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Educație</h3>
              <p className="text-gray-600">
        ...
        {/* What We Offer */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">Ce oferim</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-white rounded-lg shadow-md p-6 flex gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">Magazin selectat</h3>
                <p className="text-gray-600">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 flex gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">Licitații live</h3>
                <p className="text-gray-600">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 flex gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">Evaluări de experți</h3>
                <p className="text-gray-600">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 flex gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">Resurse educaționale</h3>
                <p className="text-gray-600">
        ...
        {/* Statistics */}
        <div className="bg-gradient-to-br from-amber-600 to-amber-800 rounded-2xl p-12 mb-16">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
            <div>
              <div className="text-4xl font-bold mb-2">5000+</div>
              <div className="text-amber-100">Monede listate</div>
            </div>
            <div>
              <div className="text-4xl font-bold mb-2">2000+</div>
              <div className="text-amber-100">Colecționari fericiți</div>
            </div>
            <div>
              <div className="text-4xl font-bold mb-2">50+</div>
              <div className="text-amber-100">Țări</div>
            </div>
            <div>
              <div className="text-4xl font-bold mb-2">100%</div>
              <div className="text-amber-100">Autentificate</div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Gata să începi colecția ta?</h2>
