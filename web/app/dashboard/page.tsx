      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
          <div className="bg-gradient-to-br from-navy-600 to-navy-800 backdrop-blur-sm p-6 rounded-2xl border border-gold-500/40 shadow-[0_12px_40px_rgba(0,0,0,0.5)] hover:-translate-y-1 hover:border-gold-400 transition-all">
            ...
            <Link
              href="/credits"
              className="mt-3 inline-flex items-center justify-center rounded-full border border-[#e7b73c]/70 px-3 py-1.5 text-xs font-semibold text-[#e7b73c] hover:bg-[#e7b73c]/10 transition-colors"
            >
              Cumpără credite (NETOPIA)
            </Link>
            {creditsError && (
