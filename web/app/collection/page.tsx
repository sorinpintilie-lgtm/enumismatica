...
export default function MyCollectionPage() {
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Trebuie să fii autentificat pentru a-ți vedea colecția
          </p>
          <Link
            href="/login"
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Page Header */}
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-2">Colecția Mea</h1>
        <p className="text-gray-600">
          Gestionează-ți colecția personală de monede și bancnote
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600 mb-1">Total Articole</p>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600 mb-1">Investiție</p>
                <p className="text-3xl font-bold text-blue-600">${stats.totalInvestment.toFixed(2)}</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600 mb-1">Profit/Pierdere</p>
                <p className={`text-3xl font-bold ${stats.totalValue >= stats.totalInvestment ? 'text-green-600' : 'text-red-600'}`}>
                  {stats.totalValue >= stats.totalInvestment ? '+' : ''}${(stats.totalValue - stats.totalInvestment).toFixed(2)}
                </p>
              </div>
              <div className={`w-12 h-12 rounded-full flex items-center justify-center ${stats.totalValue >= stats.totalInvestment ? 'bg-green-100' : 'bg-red-100'}`}>
                <svg className={`w-6 h-6 ${stats.totalValue >= stats.totalInvestment ? 'text-green-600' : 'text-red-600'}`} fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`p-2 rounded-md ${viewMode === 'grid' ? 'bg-amber-500 text-white' : 'bg-gray-200 text-gray-600 hover:bg-gray-300'}`}
            >
            ...
            <button
              ...
              className={`p-2 rounded-md ${viewMode === 'list' ? 'bg-amber-500 text-white' : 'bg-gray-200 text-gray-600 hover:bg-gray-300'}`}
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
          ...
          <button
            ...
            className="bg-amber-500 hover:bg-amber-600 text-white px-6 py-2 rounded-lg font-medium transition-colors flex items-center gap-2"
          >
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
      ...
      <div className="p-4">
        ...
        <p className="text-sm text-gray-600 mb-3">{item.denomination || 'N/A'}</p>
