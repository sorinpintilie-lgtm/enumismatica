          ...
          <div className="lg:col-span-1">
            <div className="bg-white/95 border border-[#e7b73c]/30 rounded-2xl shadow-[0_18px_55px_rgba(0,0,0,0.65)] p-6 sticky top-24 backdrop-blur-sm">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:contact@e-numismatica.ro"
              ...
              <div className="mt-8 pt-6 border-t border-gray-200/80">
                <h3 className="font-semibold text-[#000940] mb-4">Urmărește-ne</h3>
                <div className="flex gap-3">
                  <a
                    href="#"
                    className="w-10 h-10 bg-navy-900 hover:bg-[#e7b73c] rounded-lg flex items-center justify-center transition-colors group"
                  >
                    <svg className="w-5 h-5 text-slate-200 group-hover:text-[#000940]" fill="currentColor" viewBox="0 0 24 24">
