        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-24">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Contactează-ne</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@e-numismatica.ro" className="text-amber-600 hover:text-amber-700">
                      contact@e-numismatica.ro
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+40212345678" className="text-amber-600 hover:text-amber-700">
                      +40 (21) 234-5678
                    </a>
                  </div>
                </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                ...
                <div className="flex gap-3">
                  <a href="#" className="w-10 h-10 bg-gray-100 hover:bg-amber-500 rounded-lg flex items-center justify-center transition-colors group">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-amber-500 hover:bg-amber-600 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2"
                >
