...
export default function OfferModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-navy-900/95 border border-gold-500/40 rounded-2xl p-6 w-full max-w-md shadow-[0_18px_55px_rgba(0,0,0,0.85)]">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-white">Fă o ofertă</h2>
          <button
            onClick={onClose}
        ...
        <div className="mb-4">
          ...
          {currentPrice && (
            <p className="text-sm text-slate-400 mt-1">
              Preț actual: <span className="text-gold-400 font-semibold">{currentPrice} RON</span>
            </p>
          )}
        </div>
